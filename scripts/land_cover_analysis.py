...
def get_lc_mapping_inds_names_dicts(pol_path=None, 
    ...
    if pol_path is None:
        ...
        assert os.path.exists(path_dict['lc_80s_path']), f'Path {path_dict["lc_80s_path"]} does not exist' # david added (s) 'AttributeError: module 'posixpath' has no attribute 'exist'. Did you mean: 'exists'?'
